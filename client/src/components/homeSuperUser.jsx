    ...
    return (
        <div className="homeSuperUsuario" >
            <Container className="text-center mt-2 mx-auto my-5 p-5 bosy w-50" >
                <h1 className="mx-auto my-5">{name}, ¡bienvenido!</h1>
                ...
                <h1 className="mx-auto my-5">Tutorial superusuario</h1>
                ...
                <a href="/homeAdmin" className="d-block mt-5">Documentación superusuario</a>
            </Container>
        </div>
    );   
}
