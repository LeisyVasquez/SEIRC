    ...
    return (
        <div className="loanClient">
            ...
            <div className="groupButtons">
                ...
                <button type="button" class="iconAddBaskets mr-2" onClick={deleteBasket}> - </button>
            </div>
            <section className="mt-4">
                <br/>
                <p class="text-start mt-4 mb-3 d-block">Otras canastillas</p>
                ...
                <div className="groupButtons">
                    ...
                    <button type="button" class="iconAddBaskets mr-2" onClick={deleteBasketOther}> - </button>
                </div>
            </section>
            <ButtonCancel />
