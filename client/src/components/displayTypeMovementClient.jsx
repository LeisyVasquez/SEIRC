...
const DisplaypeMovementClient = () =>{
    ...
    function getQuantityTotalByMovement(){
        api.get('/getQuantityTotalByMovement/cliente').then(res => {
            if (res.status === 254) {
                swal.fire({
                    icon: 'error',
    ...
    return(
        <div className="typeMovement" >
            <Container className="text-center mt-2 mx-auto my-5 p-5 bosy w-70">
                <h1 className="m-auto py-5">Visualización por tipo de movimiento cliente</h1>
...
export default DisplaypeMovementClient;